...
/// Agent draft order: pick customer + products with qty/price.
class OrderComposePage extends ConsumerStatefulWidget {
  const OrderComposePage({super.key});

  @override
  ConsumerState<OrderComposePage> createState() => _OrderComposePageState();
}

class _OrderComposePageState extends ConsumerState<OrderComposePage> {
  bool _busy = false;
  String? _error;
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Draft order created')),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('New draft order')),
